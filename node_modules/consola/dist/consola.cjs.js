    ...
    value: function _createLogFn(defaults) {
      ...
      return function (opts) {
        ...
        if (typeof opts === 'string') {
          ...
          logObj.additional = stack.map(function (s) {
            return s.trim();
          }).join('\n');
        } else {
          // Object
...
var NS_SEPERATOR = chalk.blue(figures(' › '));
var ICONS = {
  start: figures('●'),
  info: figures('ℹ'),
  success: figures('✔'),
...
function () {
  ...
  _createClass(FancyReporter, [{
    ...
    value: function log(logObj) {
      ...
      if (logObj.scope) {
        message = (logObj.scope.replace(/:/g, '>') + '>').split('>').join(NS_SEPERATOR) + message;
      }
